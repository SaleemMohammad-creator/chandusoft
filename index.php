...
if ($slug === '' || $slug === 'index') {
    ...
    // Fetch CMS page only if not homepage
    try {
...
// Fetch recent CMS pages for navigation
...
// For homepage, set default title
if ($isHome) {
    $title = 'Home';
}
?>
